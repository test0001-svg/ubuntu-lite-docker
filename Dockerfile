...
RUN apt-get update && apt-get install -y ubuntu-mate-desktop plank xrdp xorg xorgxrdp dbus dbus-x11 sudo curl ca-certificates openssl x11-xserver-utils procps && apt-get clean && rm -rf /var/lib/apt/lists/*
